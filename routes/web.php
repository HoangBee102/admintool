...
//    'middleware' => 'admin'
    ...
    Route::group(['prefix' => 'toolfix'], function () {

        Route::get('phieu01tnt', [
            'as' => 'toolfix.ngoaitru.index', 'uses' => 'Ngoaitru\NgoaitruController@fix01tnt'
        ]);
        
        Route::post('getmsg','Ngoaitru\AjaxController@index');

        Route::post('findkhambenh', 'Ngoaitru\AjaxController@findKhambenh');
    });
